...
public class SubscribeServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (!rootNode.has("login") || !rootNode.has("password") || !rootNode.has("target")) {
            ...
            try {
                centralService.subscribe(login, password, target);
                responseMap.put("success", true);
                responseMap.put("message", String.format("User %s successfully subscribed to user %s", login, target));
