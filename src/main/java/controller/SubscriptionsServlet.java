...
public class SubscriptionsServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            try {
                HashSet<String> userSubscriptions = userService.getUserSubscriptions(login, password);
                responseMap.put("success", true);
                responseMap.put("subscriptions", mapper.writeValueAsString(userSubscriptions));
