...
public class SubscribersServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            try {
                HashSet<String> userSubscriptions = userService.getUserSubscribers(login, password);
                responseMap.put("success", true);
                responseMap.put("subscribers", mapper.writeValueAsString(userSubscriptions));
